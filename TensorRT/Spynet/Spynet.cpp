...
int main(int argc, char** argv)
{
    if (argc != 2) {
        ...
        std::cerr << "./spynet -s   // serialize model to plan file" << std::endl;
        std::cerr << "./spynet -d   // deserialize plan file and run inference" << std::endl;
        return -1;
    }
    ...
    size_t size{0};
    std::string wts_name = "./Spynet.wts";
